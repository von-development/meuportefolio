...
-- Drop views
IF OBJECT_ID (
    'portfolio.vw_PortfolioSummary',
    'V'
) IS NOT NULL
DROP VIEW portfolio.vw_PortfolioSummary;

IF OBJECT_ID (
    'portfolio.vw_AssetHoldings',
    'V'
) IS NOT NULL
DROP VIEW portfolio.vw_AssetHoldings;
GO

-- Drop triggers
IF OBJECT_ID (
    'portfolio.TR_Users_UpdateTimestamp',
    'TR'
) IS NOT NULL
DROP TRIGGER portfolio.TR_Users_UpdateTimestamp;

IF OBJECT_ID (
    'portfolio.TR_Assets_UpdateTimestamp',
    'TR'
) IS NOT NULL
DROP TRIGGER portfolio.TR_Assets_UpdateTimestamp;
GO

-- Drop procedures
IF OBJECT_ID (
    'portfolio.sp_CreateUser',
    'P'
) IS NOT NULL
DROP PROCEDURE portfolio.sp_CreateUser;

IF OBJECT_ID (
    'portfolio.sp_CreatePortfolio',
    'P'
) IS NOT NULL
DROP PROCEDURE portfolio.sp_CreatePortfolio;

IF OBJECT_ID (
    'portfolio.sp_ExecuteTransaction',
    'P'
) IS NOT NULL
DROP PROCEDURE portfolio.sp_ExecuteTransaction;

IF OBJECT_ID (
    'portfolio.sp_UpdateAssetPrice',
    'P'
) IS NOT NULL
DROP PROCEDURE portfolio.sp_UpdateAssetPrice;
GO

-- Drop functions
IF OBJECT_ID (
    'portfolio.fn_PortfolioMarketValue',
    'FN'
) IS NOT NULL
DROP FUNCTION portfolio.fn_PortfolioMarketValue;

IF OBJECT_ID (
    'portfolio.fn_PortfolioProfitPct',
    'FN'
) IS NOT NULL
DROP FUNCTION portfolio.fn_PortfolioProfitPct;
GO
